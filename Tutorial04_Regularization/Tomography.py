...
rgr_linreg.fit(proj_operator, proj.ravel())
rec_llr = rgr_linreg.coef_.reshape(l, l)
...
plt.figure(2)
plt.subplot(131)
plt.imshow(rec_llr, cmap=plt.cm.gray, interpolation='nearest')
